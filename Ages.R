...
# save percent ages by strata
pas <- perstrata[c("strata","name","lat_upper","age","percent")]
save(pas, file = "Data/Age.Strata.Prop.rda")
...
###############
# Save as a pdf
pdf("Figures/Morpho/FreqAge.Curves.Strata.pdf", width=5, height=3.5) 
stplot
dev.off()
...
############################################################################
############################################################################
# calculate the proportion of ages in each year
...
###############
# Save as a pdf
pdf("Figures/Morpho/FreqAge.Violin.1998-2005.pdf", width=6, height=4) 
yrplot
dev.off()
...
###############
# Save as a pdf
pdf("Figures/Morpho/FreqAge.Bubble.1998-2005.pdf", width=6, height=5) 
yrbubble
dev.off()
...
###############
# Save as a pdf
pdf("Figures/Morpho/FreqAge.Can.Violin.1998-2005.pdf", width=6, height=4) 
yrcanplot
dev.off()
...
###############
# Save as a pdf
pdf("Figures/Morpho/FreqAge.Can.Bubble.1998-2005.pdf", width=6, height=5) 
yrbubblecan
dev.off()
